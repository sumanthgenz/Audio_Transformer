...
class AudioFeatureExtractor:
    ...
    def extract_mfcc_chroma(self, row):
        ...
        try:
            ...
            saveDir = '/home/sgurram/kinetics/{}/{}'.format(split, str(num_label))
    ...
    def get_audio_features_parallel(self):
        ...
        result_feats = Parallel(n_jobs=12, backend='loky')(delayed(self.extract_mfcc_chroma)(row) for index, row in tqdm(master_df[550000:550005].iterrows()))
